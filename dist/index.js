...
class VeribleMCPServer {
    ...
    initializeTools() {
        ...
        this.tools.set('natural_language_query', new NaturalLanguageTool(this.configManager, this.cacheManager, this.tools));
    }
    setupHandlers() {
                        ...
                        messages: [
                            {
                                ...
                                content: {
                                    type: 'text',
                                    text: `Please perform a comprehensive code review${args?.focus_area ? ` with focus on ${args.focus_area}` : ''}.
                        ...
                        messages: [
                            {
                                ...
                                content: {
                                    type: 'text',
                                    text: `Check the code for compliance with ${args?.style_guide || 'standard'} style guide.
...
Use the natural_language_query tool with your question${args?.current_file ? `, working on ${args.current_file}` : ''}${args?.project_root ? ` in project ${args.project_root}` : ''}.
